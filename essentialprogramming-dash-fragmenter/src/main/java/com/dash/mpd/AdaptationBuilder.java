...
public class AdaptationBuilder {
    ...
    public static AdaptationSet buildAudioAdaptation(Descriptor audioRoleDescriptor, List<Representation> audioRepresentations) {
        return AdaptationSet.builder()
                ...
                .withFrameRate(AdaptionSetUtil.adjustAdaptationSetFrameRate(audioRepresentations))
    ...
    public static AdaptationSet buildVideoAdaptation(List<Representation> videoRepresentations) {
        return AdaptationSet.builder()
                ...
                .withMinFrameRate(AdaptionSetUtil.adjustMinMaxFrameRate(videoRepresentations, true))
                .withMaxFrameRate(AdaptionSetUtil.adjustMinMaxFrameRate(videoRepresentations, false))
                .withFrameRate(AdaptionSetUtil.adjustAdaptationSetFrameRate(videoRepresentations))
