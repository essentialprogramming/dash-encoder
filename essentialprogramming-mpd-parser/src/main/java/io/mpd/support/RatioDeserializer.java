...
public class RatioDeserializer extends JsonDeserializer<Ratio> {
    ...
    @Override
    public Ratio deserialize(JsonParser p, DeserializationContext context) throws IOException {
        ...
        if (matcher.matches()) {
            ...
            context.reportWrongTokenException(this, p.currentToken(), "Invalid ratio");
            return null;
        }
    }
}
