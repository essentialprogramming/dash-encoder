package io.mpd.data.descriptor;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonSubTypes;
import com.fasterxml.jackson.annotation.JsonTypeInfo;
import com.fasterxml.jackson.dataformat.xml.annotation.JacksonXmlProperty;
import io.mpd.data.descriptor.protection.Mp4Protection;
import io.mpd.data.descriptor.protection.PlayReadyContentProtection;
import io.mpd.data.descriptor.protection.WidewineProtection;
...
public class Descriptor {
    ...
    public Descriptor(String schemeIdUri, String id) {
