...
public class MPD {
    ...
    public static class Builder {
        ...
        public Builder withProgramInformations(ProgramInformation programInformation, ProgramInformation ...moreProgramInformations) {
            this.programInformations = Utils.collectToList(programInformation, moreProgramInformations);
            return this;
        }
        ...
        public Builder withPeriods(Period period, Period ...morePeriods) {
            this.periods = Utils.collectToList(period, morePeriods);
            return this;
        }
        ...
        public Builder withUtcTimings(UTCTiming utcTiming, UTCTiming ...moreUtcTiming) {
            this.utcTimings = Utils.collectToList(utcTiming, moreUtcTiming);
            return this;
        }
        ...
        public Builder withProfiles(Profile profile, Profile ...moreProfiles) {
            ...
            this.profiles = this.profiles.buildUpon()
                    .withProfiles(Utils.collectToList(profile, moreProfiles))
                    .build();
            return this;
        }
        ...
        public Builder withInteroperabilityPointsAndExtensions(String value, String ...moreValues) {
            ...
            this.profiles = this.profiles.buildUpon()
                    .withInteroperabilityPointsAndExtensions(Utils.collectToList(value, moreValues))
                    .build();
            return this;
        }
